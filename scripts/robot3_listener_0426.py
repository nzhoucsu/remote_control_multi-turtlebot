...
def miccb(data):
	if data.data == "mic_3":
		sub = rospy.Subscriber('/robot_3/recognizer/output', String, mvcb)
	else:
		sub.unregister()
...
if __name__ == '__main__':
	speed = 0.2
	msg = Twist()
	rospy.init_node('robot3_listener')

	rospy.Subscriber('to_robot3_cmd', String, mvcb)
	rospy.Subscriber('mic_label', String, miccb)	

	pub = rospy.Publisher("/robot_3/mobile_base/commands/velocity", Twist, queue_size=10)
	r = rospy.Rate(2.0)
